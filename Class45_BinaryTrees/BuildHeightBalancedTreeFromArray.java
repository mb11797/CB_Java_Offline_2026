...
public class BuildHeightBalancedTreeFromArray{
	...
	public static TreeNode buildHeightBalancedBTFromArrayHelper(int[] arr, int s, int e){
		if(s > e){
			return null;
		}
		...
		root.left = buildHeightBalancedBTFromArrayHelper(arr, s, mid-1);
		root.right = buildHeightBalancedBTFromArrayHelper(arr, mid+1, e);
		return root;
	}

	public static TreeNode buildHeightBalancedBTFromArray(int[] arr){
		return buildHeightBalancedBTFromArrayHelper(arr, 0, arr.length-1);
	}
	...
	public static void main(String[] args){
		...
		TreeNode root = buildHeightBalancedBTFromArray(arr);
