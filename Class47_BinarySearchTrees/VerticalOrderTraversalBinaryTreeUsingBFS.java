...
public class VerticalOrderTraversalBinaryTreeUsingBFS{
	...
	public static Map<Integer, List<Integer>> verticalOrderTraversalBinaryTreeUsingBFS(TreeNode root){
		...
		while(!q.isEmpty()){
			...
			List<Integer> curColNodesList = colVsNodeValuesListMap.getOrDefault(curCol, new ArrayList<Integer>());
			curColNodesList.add(curNode.data);
			colVsNodeValuesListMap.put(curCol, curColNodesList);
	...
	public static void main(String[] args){
		...
		System.out.println("Vertical Order Traversal using BFS: ");
		Map<Integer, List<Integer>> verticalOrderTraversal = verticalOrderTraversalBinaryTreeUsingBFS(root);
